...
TEST_CASE("CursorMove - move down basic") {
  setup();
  auto* lpi = make_lpi();
  auto term = make_term(lpi, 25, 80, 0, 10, 0);
...
TEST_CASE("CursorMove - move down scrolls at boundary") {
  ...
  auto term = make_term(lpi, 25, 80, 19, 10, 0);
...
TEST_CASE("CursorMove - move down stops at EOF") {
  ...
  auto term = make_term(lpi, 25, 80, 10, 10, 51);
...
TEST_CASE("CursorMove - move down stops at nullptr line") {
  ...
  auto term = make_term(lpi, 25, 80, 3, 10, 58);
...
TEST_CASE("CursorMove - move up basic") {
  setup();
  auto* lpi = make_lpi();
  auto term = make_term(lpi, 25, 80, 10, 10, 0);
...
TEST_CASE("CursorMove - move up scrolls at boundary") {
  ...
  auto term = make_term(lpi, 25, 80, 4, 10, 10);
...
TEST_CASE("CursorMove - move up at top of file with cy > 0") {
  ...
  auto term = make_term(lpi, 25, 80, 3, 10, 0);
...
TEST_CASE("CursorMove - move left basic") {
  setup();
  auto* lpi = make_lpi();
  auto term = make_term(lpi, 25, 80, 0, 20, 0);
